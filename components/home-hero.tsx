        ...
        <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.7 }}>
          ...
          <div className="mt-8 flex flex-col sm:flex-row sm:flex-wrap gap-3 sm:gap-4">
            <Link
              ...
              target="_blank"
              className="w-full sm:w-auto justify-center rounded-2xl bg-amber-500 px-6 py-3 text-[#0A192F] font-semibold inline-flex items-center gap-2 transition-all duration-300 hover:scale-[1.02]"
            >
              Book a Session <ArrowRight className="w-5 h-5" />
            </Link>
            <Link
              href="/contact"
              className="w-full sm:w-auto text-center rounded-2xl border border-white/50 px-6 py-3 text-white font-semibold transition-all duration-300 hover:scale-[1.02]"
            >
              Work With Me
            </Link>
            <Link
              href="/speaking"
              className="w-full sm:w-auto justify-center rounded-2xl border border-white/50 px-6 py-3 text-white font-semibold transition-all duration-300 hover:scale-[1.02] inline-flex items-center gap-2"
            >
