  ...
  return (
    <section className="py-16 sm:py-20 bg-slate-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-[#0A192F]">Services</h1>
        ...
        <div className="mt-8 sm:mt-10 grid gap-4 sm:gap-6 md:grid-cols-2 lg:grid-cols-3">
          {services.map(({ icon: Icon, title, text }) => (
            ...
            >
              ...
              <h2 className="mt-4 text-2xl md:text-3xl font-semibold text-[#0A192F]">{title}</h2>
